...
export function runHubStage(domain) {
  ...
  const html = fillTemplate(template, {
    PAGE_TITLE: escapeHtml(`${domain.entityLabels.leafPlural} — Food Ontology Directory`),
    META_DESCRIPTION: escapeHtml(
      `Explore ${domain.expectedCounts.leaf} ${domain.entityLabels.leafCount} across ${domain.expectedCounts.groups} groups in the Pairing Method food ontology.`
    ),
