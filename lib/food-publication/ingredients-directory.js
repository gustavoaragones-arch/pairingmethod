...
<p class="term-entity-label">Food Ontology</p>
<h1>Ingredients</h1>
</header>`,
    `<section class="direct-answer narrative-summary narrative-intro" aria-label="About this directory">
<h2>About This Directory</h2>
<p>The Pairing Method food ontology is organized into ${domains.length} published domains, covering ${totalLeaf} ingredients in total. Each domain groups its ingredients by culinary category and explains how they pair with wine.</p>
</section>`,
  ...
  return [
    {
      ...
      "@type": "CollectionPage",
      name: "Ingredients — Food Ontology Directory",
      url: CANONICAL_URL,
...
export function runIngredientsDirectoryStage(root) {
  ...
  const html = fillTemplate(template, {
    PAGE_TITLE: "Ingredients — Food Ontology Directory | Pairing Method",
    META_DESCRIPTION: "Browse every published food domain in the Pairing Method ontology — fruits, vegetables, proteins, grains, and more — each with wine pairing guidance.",
    CANONICAL_URL,
    OG_URL: CANONICAL_URL,
    OG_TITLE: "Ingredients — Food Ontology Directory",
