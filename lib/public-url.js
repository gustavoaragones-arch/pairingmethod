...
/**
 * @param {string} slug Wine style slug (e.g. barolo, champagne)
 * @returns {string}
 */
export function wineStyleUrl(slug) {
  return `/styles/${normalizeSlug(slug)}/`;
}

/**
 * @param {string} slug Wine region slug (e.g. bordeaux, napa-valley)
 * @returns {string}
 */
export function wineRegionUrl(slug) {
  return `/regions/${normalizeSlug(slug)}/`;
}

/**
 * @param {string} slug Wine serving entity slug
 * @returns {string}
 */
export function wineServingUrl(slug) {
  return `/serving/${normalizeSlug(slug)}/`;
}

/**
 * @param {string} slug Winemaking technique slug
 * @returns {string}
 */
export function winemakingTechniqueUrl(slug) {
  return `/techniques/${normalizeSlug(slug)}/`;
}

/**
 * @param {string} slug Wine fault slug
 * @returns {string}
 */
export function wineFaultUrl(slug) {
  return `/faults/${normalizeSlug(slug)}/`;
}

/**
 * @param {string} slug Protein food slug (e.g. ribeye, salmon-fillet)
 * @returns {string}
 */
export function proteinFoodUrl(slug) {
  return `/foods/${normalizeSlug(slug)}/`;
}

/**
 * @param {string} slug Protein group slug (e.g. beef, fin-fish)
 * @returns {string}
 */
export function proteinGroupUrl(slug) {
  return `/groups/${normalizeSlug(slug)}/`;
}

/**
 * @param {string} slug Protein category slug (e.g. animal-protein)
 * @returns {string}
 */
export function proteinCategoryUrl(slug) {
  return `/categories/${normalizeSlug(slug)}/`;
}

/**
 * @returns {string}
 */
export function proteinFoodsHubUrl() {
  return "/foods/";
}

/**
 * @param {string} slug Cheese slug (e.g. brie-de-meaux)
 * @returns {string}
 */
export function cheeseUrl(slug) {
  return `/cheeses/${normalizeSlug(slug)}/`;
}

/**
 * @param {string} slug Cheese group slug (e.g. bloomy-rind)
 * @returns {string}
 */
export function cheeseGroupUrl(slug) {
  return `/cheese-groups/${normalizeSlug(slug)}/`;
}

/**
 * @param {string} slug Cheese category slug (e.g. cheese)
 * @returns {string}
 */
export function cheeseCategoryUrl(slug) {
  return `/cheese-categories/${normalizeSlug(slug)}/`;
}

/**
 * @returns {string}
 */
export function cheesesHubUrl() {
  return "/cheeses/";
}
