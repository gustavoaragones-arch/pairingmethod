...
export const DOMAIN_DEPLOYMENTS = Object.freeze([
  Object.freeze({
    ...
    expectedSitemapCounts: Object.freeze({
      leaf: 159,
      groups: 17,
      categories: 3,
      total: 179,
  ...
  Object.freeze({
    ...
    htmlDistSections: Object.freeze(["fruits", "fruit-groups", "fruit-categories"]),
    promotedTargets: Object.freeze(["fruits", "fruit-groups", "fruit-categories"]),
    cacheHtmlPaths: Object.freeze([
      "/fruits/*",
      "/fruit-groups/*",
      "/fruit-categories/*",
  ...
  Object.freeze({
    ...
    htmlDistSections: Object.freeze(["nut-seeds", "nut-seed-groups", "nut-seed-categories"]),
    promotedTargets: Object.freeze(["nut-seeds", "nut-seed-groups", "nut-seed-categories"]),
    cacheHtmlPaths: Object.freeze([
      "/nut-seeds/*",
      "/nut-seed-groups/*",
      "/nut-seed-categories/*",
    ...
    liveSamples: Object.freeze([
      "/nut-seeds/almond/",
      "/nut-seed-groups/tree-nuts/",
      "/nut-seed-categories/nut-seed/",
    ]),
  }),
  Object.freeze({
    id: "legume",
    ...
    htmlDistSections: Object.freeze(["legumes", "legume-groups", "legume-categories"]),
    promotedTargets: Object.freeze(["legumes", "legume-groups", "legume-categories"]),
    cacheHtmlPaths: Object.freeze([
      "/legumes/*",
      "/legume-groups/*",
      "/legume-categories/*",
    ...
    liveSamples: Object.freeze([
      "/legumes/chickpea/",
      "/legume-groups/beans/",
      "/legume-categories/legume/",
    ]),
  }),
  Object.freeze({
    id: "sweet-flavor",
    publicationId: "sweet-flavor-ontology",
    promotionPaths: Object.freeze([
      { source: "dist/sweet-flavors", target: "sweet-flavors" },
      { source: "dist/sweet-flavor-groups", target: "sweet-flavor-groups" },
      { source: "dist/sweet-flavor-categories", target: "sweet-flavor-categories" },
    ]),
    sitemapFiles: Object.freeze([
      "sitemaps/sweet-flavor-pages.xml",
      "sitemaps/sweet-flavor-group-pages.xml",
      "sitemaps/sweet-flavor-category-pages.xml",
    ]),
    expectedHtmlCounts: Object.freeze({
      leaf: 73,
      groups: 6,
    ...
    htmlDistSections: Object.freeze(["sweet-flavors", "sweet-flavor-groups", "sweet-flavor-categories"]),
    promotedTargets: Object.freeze(["sweet-flavors", "sweet-flavor-groups", "sweet-flavor-categories"]),
    cacheHtmlPaths: Object.freeze([
      "/sweet-flavors/*",
      "/sweet-flavor-groups/*",
    ...
    hubPath: "/sweet-flavors/",
    pageModelPaths: Object.freeze({
      leaf: "data/pages/sweet-flavor-pages.json",
      group: "data/pages/sweet-flavor-group-pages.json",
      category: "data/pages/sweet-flavor-category-pages.json",
    }),
    navigationPaths: Object.freeze({
      leaf: "data/navigation/sweet-flavor-links.json",
      group: "data/navigation/sweet-flavor-group-links.json",
      category: "data/navigation/sweet-flavor-category-links.json",
    }),
    reports: Object.freeze({
      publication: "reports/sweet-flavor-publication-certification-report.json",
      release: "reports/sweet-flavor-release-certification-report.json",
      html: "reports/sweet-flavor-html-render-report.json",
      sitemap: "reports/sweet-flavor-sitemap-report.json",
      promotion: "reports/promotion-report.json",
    }),
    liveSamples: Object.freeze([
      "/sweet-flavors/cane-sugar/",
      "/sweet-flavor-groups/sugars/",
      "/sweet-flavor-categories/sweet-flavor/",
    ]),
  }),
  Object.freeze({
    id: "sauce-condiment",
    publicationId: "sauce-condiment-ontology",
    promotionPaths: Object.freeze([
      { source: "dist/sauce-condiments", target: "sauce-condiments" },
      { source: "dist/sauce-condiment-groups", target: "sauce-condiment-groups" },
      { source: "dist/sauce-condiment-categories", target: "sauce-condiment-categories" },
    ]),
    sitemapFiles: Object.freeze([
      "sitemaps/sauce-condiment-pages.xml",
      "sitemaps/sauce-condiment-group-pages.xml",
      "sitemaps/sauce-condiment-category-pages.xml",
    ]),
    expectedHtmlCounts: Object.freeze({
      leaf: 90,
      groups: 6,
    ...
    htmlDistSections: Object.freeze(["sauce-condiments", "sauce-condiment-groups", "sauce-condiment-categories"]),
    promotedTargets: Object.freeze(["sauce-condiments", "sauce-condiment-groups", "sauce-condiment-categories"]),
    cacheHtmlPaths: Object.freeze([
      "/sauce-condiments/*",
      "/sauce-condiment-groups/*",
    ...
    hubPath: "/sauce-condiments/",
    pageModelPaths: Object.freeze({
      leaf: "data/pages/sauce-condiment-pages.json",
      group: "data/pages/sauce-condiment-group-pages.json",
      category: "data/pages/sauce-condiment-category-pages.json",
    }),
    navigationPaths: Object.freeze({
      leaf: "data/navigation/sauce-condiment-links.json",
      group: "data/navigation/sauce-condiment-group-links.json",
      category: "data/navigation/sauce-condiment-category-links.json",
    }),
    reports: Object.freeze({
      publication: "reports/sauce-condiment-publication-certification-report.json",
      release: "reports/sauce-condiment-release-certification-report.json",
      html: "reports/sauce-condiment-html-render-report.json",
      sitemap: "reports/sauce-condiment-sitemap-report.json",
      promotion: "reports/promotion-report.json",
    }),
    liveSamples: Object.freeze([
      "/sauce-condiments/mayonnaise/",
      "/sauce-condiment-groups/mother-sauces/",
      "/sauce-condiment-categories/sauce-condiment/",
    ]),
  }),
]);
