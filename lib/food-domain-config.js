...
const NUT_SEED_DOMAIN = Object.freeze({
  id: "nut-seed",
  publicationId: "nut-seed-ontology",
  phasePrefix: "FOOD-10F",
  certificationPhase: "FOOD-10F",
  entityLabels: {
    leaf: "Nut & Seed",
    group: "Nut & Seed Group",
    category: "Nut & Seed Category",
    leafPlural: "Nuts & Seeds",
    leafCount: "nuts & seeds",
  },
  pageTypes: {
    leaf: "nut_seed",
    group: "nut_seed_group",
    category: "nut_seed_category",
    suggestions: "nut_seed_search_suggestions",
  },
  projectionTypes: {
    leaf: "nut_seed",
    group: "nut_seed_group",
  ...
  groupDisplayField: "name",
  categoryDisplayField: "name",
  runtimeLayout: "nut-seed",
  runtimeMemberIdsKey: "nut_seed_ids",
  runtimeMemberSlugsKey: "nut_seed_slugs",
  runtimeGroupSlugsKey: "group_slugs",
  intrinsicFields: [
    "culinary_group",
    "usage_intensity",
  ...
  linkSections: {
    leaf: {
      similar_nuts_seeds: "Similar nuts & seeds",
      substitutions: "Substitutions",
      commonly_served_with: "Commonly served with",
      primary_wine_styles: "Primary wine styles",
      alternative_wine_styles: "Alternative wine styles",
    ...
    group: {
      member_nuts_seeds: "Member nuts & seeds",
      related_groups: "Related groups",
    },
    category: {
      groups: "Groups",
  ...
  metadata: {
    leafTitleSuffix: "Nut & Seed Guide",
    groupTitleSuffix: "Nut & Seed Group",
    categoryTitleSuffix: "Nut & Seed Category",
    leafDescriptionTail: "nut or seed",
    ontologyName: "Nut & Seed Ontology",
  },
  urls: {
    leafPrefix: "/nut-seeds/",
    groupPrefix: "/nut-seed-groups/",
    categoryPrefix: "/nut-seed-categories/",
    hubPath: "/nut-seeds/",
    internalPrefixes: ["/nut-seeds/", "/nut-seed-groups/", "/nut-seed-categories/"],
  },
  paths: {
    catalog: "data/nut-seed-catalog.json",
    runtime: [
      "data/runtime/nut-seed-bootstrap.json",
      "data/runtime/nut-seed-groups.json",
      "data/runtime/nut-seed-categories.json",
      "data/runtime/nut-seed-indexes.json",
    ],
    relationships: [
      "data/runtime/nut-seed-relationships.json",
      "data/runtime/nut-seed-editorial-relationships.json",
      "data/runtime/nut-seed-wine-relationships.json",
    ],
    projections: {
      leaf: "data/generated/nut-seed-pages.json",
      group: "data/generated/nut-seed-group-pages.json",
      category: "data/generated/nut-seed-category-pages.json",
    },
    pages: {
      leaf: "data/pages/nut-seed-pages.json",
      group: "data/pages/nut-seed-group-pages.json",
      category: "data/pages/nut-seed-category-pages.json",
    },
    schema: {
      leaf: "data/schema/nut-seed-schema.json",
      group: "data/schema/nut-seed-group-schema.json",
      category: "data/schema/nut-seed-category-schema.json",
    },
    navigation: {
      leaf: "data/navigation/nut-seed-links.json",
      group: "data/navigation/nut-seed-group-links.json",
      category: "data/navigation/nut-seed-category-links.json",
    },
    search: {
      leaf: "data/search/nut-seed-search-index.json",
      group: "data/search/nut-seed-group-search-index.json",
      category: "data/search/nut-seed-category-search-index.json",
      suggestions: "data/search/nut-seed-search-suggestions.json",
    },
    html: {
      leaf: "dist/nut-seeds",
      group: "dist/nut-seed-groups",
      category: "dist/nut-seed-categories",
    },
    sitemaps: {
      index: "dist/sitemap.xml",
      leaf: "dist/sitemaps/nut-seed-pages.xml",
      group: "dist/sitemaps/nut-seed-group-pages.xml",
      category: "dist/sitemaps/nut-seed-category-pages.xml",
      crawlManifest: "dist/crawl-manifest.json",
    },
    releaseManifest: "dist/release-manifest.json",
    reports: {
      generator: "reports/nut-seed-generator-report.json",
      pages: "reports/nut-seed-page-generation-report.json",
      schema: "reports/nut-seed-schema-generation-report.json",
      links: "reports/nut-seed-internal-link-report.json",
      search: "reports/nut-seed-search-index-report.json",
      publication: "reports/nut-seed-publication-certification-report.json",
      coverage: "reports/nut-seed-publication-coverage-report.json",
      html: "reports/nut-seed-html-render-report.json",
      sitemap: "reports/nut-seed-sitemap-report.json",
      release: "reports/nut-seed-release-certification-report.json",
    },
  },
  render: {
    template: "protein-entity-template.html",
    entityClasses: {
      leaf: "nut-seed-entity-page",
      group: "nut-seed-group-entity-page",
      category: "nut-seed-category-entity-page",
    },
    cssPrefix: "nut-seed",
    module: "../taxonomy-nut-seed-render.js",
    exports: {
      leaf: "renderNutSeedSections",
      group: "renderNutSeedGroupSections",
      category: "renderNutSeedCategorySections",
      assemble: "assembleNutSeedEntityPage",
    },
  },
  deployment: {
    promotionPaths: [
      { source: "dist/nut-seeds", target: "nut-seeds" },
      { source: "dist/nut-seed-groups", target: "nut-seed-groups" },
      { source: "dist/nut-seed-categories", target: "nut-seed-categories" },
    ],
    sitemapFiles: [
      "sitemaps/nut-seed-pages.xml",
      "sitemaps/nut-seed-group-pages.xml",
      "sitemaps/nut-seed-category-pages.xml",
    ],
    cacheHtmlPaths: ["/nut-seeds/*", "/nut-seed-groups/*", "/nut-seed-categories/*"],
    smokeSamples: {
      leaf: ["almond", "peanut", "tahini", "chia-seed", "pistachio", "sesame", "walnut", "flaxseed", "chestnut", "peanut-butter"],
      group: ["tree-nuts", "peanuts", "edible-seeds", "seed-spices", "nut-products", "seed-products"],
      category: ["nut-seed"],
    },
  },
  expectedCounts: {
  ...
  releaseSummary: {
    canonicalNutSeeds: 89,
    runtimeRelationships: 2727,
    editorialRelationships: 284,
    wineRelationships: 215,
    publicationPages: 96,
  },
  certifyScript: "certify:nut-seed-publication",
  htmlPrerequisiteScript: "generate:nut-seed-html",
});

const LEGUME_DOMAIN = Object.freeze({
  id: "legume",
  publicationId: "legume-ontology",
  phasePrefix: "FOOD-11F",
  certificationPhase: "FOOD-11F",
  entityLabels: {
    leaf: "Legume",
    group: "Legume Group",
    category: "Legume Category",
    leafPlural: "Legumes",
    leafCount: "legumes",
  },
  pageTypes: {
    ...
    suggestions: "legume_search_suggestions",
  },
  projectionTypes: {
    leaf: "legume",
    group: "legume_group",
  ...
  groupDisplayField: "name",
  categoryDisplayField: "name",
  runtimeLayout: "legume",
  runtimeMemberIdsKey: "legume_ids",
  runtimeMemberSlugsKey: "legume_slugs",
  runtimeGroupSlugsKey: "group_slugs",
  intrinsicFields: [
    "culinary_group",
    "usage_intensity",
  ...
  editorial: {
    ...
    crossDomainTargets: ["commonly_served_with"],
    preparationPrefix: null,
    intraDomainRelationships: ["similar_to"],
  },
  wine: {
    byRelationship: {
      pairs_with_style: "primary_wine_styles",
  ...
  linkSections: {
    leaf: {
      similar_legumes: "Similar legumes",
      commonly_served_with: "Commonly served with",
      primary_wine_styles: "Primary wine styles",
      alternative_wine_styles: "Alternative wine styles",
      wine_descriptors: "Wine descriptors",
  ...
  metadata: {
    leafTitleSuffix: "Legume Guide",
    groupTitleSuffix: "Legume Group",
    categoryTitleSuffix: "Legume Category",
    leafDescriptionTail: "legume",
    ontologyName: "Legume Ontology",
  },
  urls: {
    leafPrefix: "/legumes/",
    groupPrefix: "/legume-groups/",
    categoryPrefix: "/legume-categories/",
    hubPath: "/legumes/",
    internalPrefixes: ["/legumes/", "/legume-groups/", "/legume-categories/"],
  },
  paths: {
    catalog: "data/legume-catalog.json",
    runtime: ["data/runtime/legume-runtime.json"],
    relationships: [
    ...
    projections: {
      leaf: "data/generated/legume-pages.json",
      group: "data/generated/legume-group-pages.json",
      category: "data/generated/legume-category-pages.json",
    },
    pages: {
      leaf: "data/pages/legume-pages.json",
      group: "data/pages/legume-group-pages.json",
      category: "data/pages/legume-category-pages.json",
    },
    schema: {
      leaf: "data/schema/legume-schema.json",
      group: "data/schema/legume-group-schema.json",
      category: "data/schema/legume-category-schema.json",
    },
    navigation: {
      leaf: "data/navigation/legume-links.json",
      group: "data/navigation/legume-group-links.json",
      category: "data/navigation/legume-category-links.json",
    },
    search: {
      leaf: "data/search/legume-search-index.json",
      group: "data/search/legume-group-search-index.json",
      category: "data/search/legume-category-search-index.json",
      suggestions: "data/search/legume-search-suggestions.json",
    },
    html: {
      leaf: "dist/legumes",
      group: "dist/legume-groups",
      category: "dist/legume-categories",
    },
    sitemaps: {
      index: "dist/sitemap.xml",
      leaf: "dist/sitemaps/legume-pages.xml",
      group: "dist/sitemaps/legume-group-pages.xml",
      category: "dist/sitemaps/legume-category-pages.xml",
      crawlManifest: "dist/crawl-manifest.json",
    },
    releaseManifest: "dist/release-manifest.json",
    reports: {
      generator: "reports/legume-generator-report.json",
      pages: "reports/legume-page-generation-report.json",
      schema: "reports/legume-schema-generation-report.json",
      links: "reports/legume-internal-link-report.json",
      search: "reports/legume-search-index-report.json",
      publication: "reports/legume-publication-certification-report.json",
      coverage: "reports/legume-publication-coverage-report.json",
      html: "reports/legume-html-render-report.json",
      sitemap: "reports/legume-sitemap-report.json",
      release: "reports/legume-release-certification-report.json",
    },
  },
  render: {
    template: "protein-entity-template.html",
    entityClasses: {
      leaf: "legume-entity-page",
      group: "legume-group-entity-page",
      category: "legume-category-entity-page",
    },
    cssPrefix: "legume",
    module: "../taxonomy-legume-render.js",
    exports: {
      leaf: "renderLegumeSections",
      group: "renderLegumeGroupSections",
      category: "renderLegumeCategorySections",
      assemble: "assembleLegumeEntityPage",
    },
  },
  deployment: {
    promotionPaths: [
      { source: "dist/legumes", target: "legumes" },
      { source: "dist/legume-groups", target: "legume-groups" },
      { source: "dist/legume-categories", target: "legume-categories" },
    ],
    sitemapFiles: [
      "sitemaps/legume-pages.xml",
      "sitemaps/legume-group-pages.xml",
      "sitemaps/legume-category-pages.xml",
    ],
    cacheHtmlPaths: ["/legumes/*", "/legume-groups/*", "/legume-categories/*"],
    smokeSamples: {
      leaf: [
        "chickpea",
        "black-bean",
      ...
      group: ["beans", "peas", "lentils", "chickpeas", "other-legumes", "legume-products"],
      category: ["legume"],
    },
  },
  expectedCounts: {
  ...
  releaseSummary: {
    canonicalLegumes: 75,
    runtimeRelationships: 2114,
    editorialRelationships: 280,
    wineRelationships: 199,
    publicationPages: 82,
  },
  certifyScript: "certify:legume-publication",
  htmlPrerequisiteScript: "generate:legume-html",
});
...
const DOMAINS = Object.freeze({
  ...
  fruit: FRUIT_DOMAIN,
  "nut-seed": NUT_SEED_DOMAIN,
  legume: LEGUME_DOMAIN,
});
